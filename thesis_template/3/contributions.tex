...
All in all, the outcome is positive with the daytime test giving an 80\% and the evening test giving 110\% improvement. The different results are caused by the selection of acceptable error values, which can be fine tuned based on the actual measurement characteristics needed. 
