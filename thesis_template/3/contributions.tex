...
\todo{explain this equation and how rmse is connected to it}
...
\todo{Add an overall figure of the solution here}
...
\todo{Add a test link bandwidth used and mention 3G connection problems}
\todo{add jetty web server capability references with avg request handle time}
% ---------------------------------------------------------------------------
